...
| Grupo | Features |
|---|---|
| Calendario | `ano`, `mes`, `dia_mes`, `semana_mes`, `semana_ano`, `dia_semana_num`, `trimestre`, `semestre`, `eh_semana_5`, `eh_fim_semana`, `eh_inicio_mes`, `eh_fim_mes`, `dias_no_mes` |
...
- numericas agregadas por filial, escaladas com prefixo `num__`;
- categoricas cadastrais em one-hot, com prefixo `cat__`;
- ratios de comportamento por `semana_mes x dia_semana_num`, com prefixo `ratio_semana_dia__`.
